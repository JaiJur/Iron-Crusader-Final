class Player {
    ...
    mouseMove(target) {
        this.mouseX = target.layerX;
        this.mouseY = target.layerY;
    }
    ...
    getDamageZombie(){
        ...
        if (this.contDamage > 50){
            ...
            let audioTurret = document.getElementById('audioHerida').play()
        ...
        if (this.lives < 1){
            let audioDeath = document.getElementById('audioDeath').play()
            this.playerDeath();
        }
    }
