class GameManager{
    ...
    constructor(canvasId){
        ...
        this.audioMain = document.getElementById('audioMain');
    ...
    mouseDownEvent(target){
        ...
        this.bulletX = target.layerX;
        this.bulletY = target.layerY;  
    ...
    update(){
        ...
        if (this.player.isDead){
            ...
            gameCanvas.classList.add('ocultar')
    ...
    createZombie(){
        ...
        if (this.zombiesArr.length <= 8) {
            ...
            let audioZombie = document.getElementById('audioZombie').play()
    ...
    createTurret(){
        ...
        if (this.turretsArr.length <= 5){
            ...
            let audioTurret = document.getElementById('audioTurret').play()
    ...
    resetEnemies(){
        ...
        for (let zombie of this.zombiesArr) { this.zombiesArr.pop(); }

        for (let turret of this.turretsArr) { this.turretsArr.pop(); }

        for (let bullet of this.turretBulletsArr) { this.turretBulletsArr.pop(); }

        for (let bullet of this.bulletsArr) { this.bulletsArr.pop(); }
    }
    ...
    createBullet(){
       ...
       const bullet = new Bullet(this.ctx, Math.floor(this.player.x + this.player.width / 2), Math.floor(this.player.y + this.player.height/2), this.bulletX, this.bulletY) 
        let audioBullet = document.getElementById('audioShoot').play()
    ...
    createTurretBullet(){
        ...
        for (let turret of this.turretsArr){
            ...
            if (turret.triggerCont === 99){
                let audioBullet = document.getElementById('audioBullet').play()
    ...
    restartGame(){
        ...
        if (this.toRestart){
            ...
            let menuDeath = document.getElementById("container-death")
            menuDeath.classList.add("ocultar")
    ...
    setRanking(scoreTest){
        ...
        this.ranking.updateTest(scoreTest)
    ...
    setDeathScores(){
        ...
        document.getElementById('min-death').innerHTML = this.crono.minutes;
        document.getElementById('sec-death').innerHTML = this.crono.seconds;
        document.getElementById('kills-death').innerHTML = this.kills;
        document.getElementById('score-death').innerHTML = document.getElementById('data-last').innerHTML;

        menuDeath.classList.remove("ocultar")
